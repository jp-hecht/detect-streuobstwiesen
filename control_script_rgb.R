...
tuning_run(
   file = "R_NN/Ba_funfter_Anlauf_RGB.R",
   #file = system.file(file = "C:/Users/geoUniMarburg/Desktop/Jonathan/NN/R_NN/Ba_funfter_Anlauf_RGB.R",package = "tfruns"),
...
b2 <- raster("./data/sen/Wasp/fin/WASP_sen_2_cro_he_c_1_99.tif")
